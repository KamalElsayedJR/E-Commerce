...
{
    /// <inheritdoc />
    public partial class CreateOrderModuleOrderDeliveryMethodOrderItem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipToAddress_Fname = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShipToAddress_Lname = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    PaymentIntedntId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
